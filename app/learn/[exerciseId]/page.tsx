...
const exerciseRegistry: Record<number, () => Promise<ExerciseConfig>> = {
    ...
    4: async () => {
        const { exercise4Config } = await import(
            "@/exercises/exercise-4/config"
        );
        return exercise4Config;
    },
    5: async () => {
        const { exercise5Config } = await import(
            "@/exercises/exercise-5/config"
        );
    ...
    7: async () => {
        const { exercise7Config } = await import(
            "@/exercises/exercise-7/config"
        );
        return exercise7Config;
    },
    8: async () => {
        const { exercise8Config } = await import(
            "@/exercises/exercise-8/config"
        );
    ...
    10: async () => {
        const { exercise10Config } = await import(
            "@/exercises/exercise-10/config"
        );
        return exercise10Config;
    },
};
